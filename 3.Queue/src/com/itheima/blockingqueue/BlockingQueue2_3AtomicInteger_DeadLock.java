...
//解决AtomicIntegery优化后死锁问题：tailLock和headLock平行，不要嵌套
public class BlockingQueue2_3AtomicInteger_DeadLock<E> implements BlockingQueue<E>{
    ...
    public BlockingQueue2_3AtomicInteger_DeadLock(int capacity) {
